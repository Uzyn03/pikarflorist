    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12 lg:mb-16 space-y-4">
        ...
        <p class="text-lightBeige text-lg max-w-2xl mx-auto">
          Temukan kami di lokasi workshop di Bandung untuk melayani kebutuhan bunga Anda
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div class="space-y-4">
            <!-- Phone -->
            <a href="tel:+6283160641549" class="flex items-center gap-3 text-lightBeige hover:text-golden transition-colors group">
            ...
            <!-- Email -->
            <a href="mailto:pikarflorist@gmail.com" class="flex items-center gap-3 text-lightBeige hover:text-golden transition-colors group">
              <div class="w-10 h-10 bg-cream rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-golden/20 transition-colors">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Instagram -->
            <a href="https://www.instagram.com/toko__bunga___bandung_24jam?igsh=MXVkdnZ2OHBiMGhvdA%3D%3D&utm_source=qr" target="_blank" class="flex items-center gap-3 text-lightBeige hover:text-golden transition-colors group">
              <div class="w-10 h-10 bg-cream rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-golden/20 transition-colors">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
